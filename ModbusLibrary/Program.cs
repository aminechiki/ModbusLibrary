...
namespace ModbusLibrary
{
    class Program
    {
        ...
        {    
            ...
            // - WRITE
            int[] valueMultipleRegisters = { 0, 3434 };
            ...
            deviceRtu.writeSingleRegister(1, 8961, 0);
            //fc 16 - write multiple registers
            //deviceRtu.writeMultipleRegisters(1, 8959, valueMultipleRegisters);
            ...
            //fc 03 read holding registers
            //deviceTcp.readHoldingRegisters(1, 8527, 4);
            //fc 04 read input registers
            ...
            //fc 06 - write single register
            //deviceTcp.writeSingleRegister(1, 8959, 1);
            //fc 16 - write multiple registers
